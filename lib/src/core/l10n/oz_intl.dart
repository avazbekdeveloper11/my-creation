...
const ozDateSymbols = {
  ...
  'STANDALONENARROWMONTHS': ['Й', 'Ф', 'М', 'А', 'М', 'И', 'И', 'А', 'С', 'О', 'Н', 'Д'],
  ...
  'SHORTMONTHS': ['ян', 'фев', 'мар', 'апр', 'май', 'июн', 'июл', 'авг', 'сен', 'окт', 'ной', 'дек'],
  'STANDALONESHORTMONTHS': ['Ян', 'Фев', 'Мар', 'Апр', 'Май', 'Июн', 'Июл', 'Авг', 'Сен', 'Окт', 'Ной', 'Дек'],
