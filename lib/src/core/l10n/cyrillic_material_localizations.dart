...
// #docregion Delegate
class _CyrillicMaterialLocalizationsDelegate extends LocalizationsDelegate<MaterialLocalizations> {
  const _CyrillicMaterialLocalizationsDelegate();

  @override
  bool isSupported(Locale locale) => locale.languageCode == 'oz' && locale.countryCode == 'UZ';
...
class CyrillicMaterialLocalizations extends GlobalMaterialLocalizations {
  ...
  @override
  String get dateRangeStartDateSemanticLabelRaw => r'Бошланиш санаси: $fullDate';
  ...
  @override
  String get pageRowsInfoTitleApproximateRaw => r'$firstRow–$lastRow, жами: $rowCount';
  ...
  @override
  String get remainingTextFieldCharacterCountOther => r'$remainingCount та белги қолди';
  ...
  @override
  String get selectedRowCountTitleOther => r'$selectedRowCount та элемент танланди';
  ...
  @override
  List<String> get narrowWeekdays => const <String>['Й', 'Д', 'С', 'Ч', 'П', 'Ж', 'Ш'];

  @override
  int get firstDayOfWeekIndex => 0;

  static const LocalizationsDelegate<MaterialLocalizations> delegate = _CyrillicMaterialLocalizationsDelegate();
  ...
  @override
  String get clearButtonTooltip => 'Тозалаш';

  @override
  String get selectedDateLabel => 'Танланган сана';
}
