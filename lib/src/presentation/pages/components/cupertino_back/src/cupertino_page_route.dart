...
mixin CupertinoRouteTransitionMixin<T> on PageRoute<T> {
  ...
  ///    would be allowed.
  static bool isPopGestureInProgress(PageRoute<dynamic> route) => route.navigator!.userGestureInProgress;
...
final Animatable<double> _dialogScaleTween =
    Tween<double>(begin: 1.3, end: 1).chain(CurveTween(curve: Curves.linearToEaseOut));
